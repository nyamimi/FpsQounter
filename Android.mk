...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"fps-qounter"' -DVERSION='"1.0.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
